...
function builder(options) {
  ...
  if (!options.network) {
    options.network = vkaxcore.Networks.defaultNetwork;
  }

  options.Block = options.Block || vkaxcore.Block;
  options.BlockHeader = options.BlockHeader || vkaxcore.BlockHeader;
  options.Transaction = options.Transaction || vkaxcore.Transaction;
  options.MerkleBlock = options.MerkleBlock || vkaxcore.MerkleBlock;
  options.MnListDiff = options.MnListDiff || vkaxcore.MnListDiff;
